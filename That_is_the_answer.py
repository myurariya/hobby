...
letters = ["あ","い","う","え","お","か","き","く","け","こ","さ",\
    "し","す","せ","そ","た","ち","つ","て","と","な","の","は","ひ","ふ"\
    ,"へ","ほ","よ","ろ","り","じ"]
...
theme_list = ["赤いもの","四角いもの","青いもの","黄色いもの","緑色のもの","黒いもの","白いもの","あたたまるもの","読みたいもの","子供が好きなもの",\
    ...
    "お買い得なもの","便利なもの","びっくりすること","一人暮らしに便利なもの","カッコいいもの","流行っているもの","やっておくべきこと","頭を使うこと",\
...
def pushed():
    ...
    label_2.destroy()
    if len(letters) == 0:
        letters = ["あ","い","う","え","お","か","き","く","け","こ","さ","し","す","せ","そ","た","ち","つ","て","と","な","の","は","ひ","ふ"\
    ,"へ","ほ","よ","ろ","り","じ"]
    init = letters[random.randrange(len(letters))]
    theme = theme_list[random.randrange(len(theme_list))]
